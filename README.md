...
[![Current Version](https://img.shields.io/badge/version-1.0.7-green.svg)](https://github.com/soumanpaul/FoodZone-React-frontend)
...
[![GitHub Stars](https://img.shields.io/github/stars/soumanpaul/node-chat.svg)](https://github.com/soumanpaul/FoodZone-React-frontend/stargazers)
[![GitHub Issues](https://img.shields.io/github/issues/soumanpaul/node-chat.svg)](https://github.com/soumanpaul/FoodZone-React-frontend/issues)  
...
## Features
  ...
  - [x] Find all Dishes
  - [x] Order Dishes
  - [x] Add Dishes in favorate section
  - [x] Post a comment on dishes
  - [x] Reserve a table
  - [x] Write a feedback
---
## Built With
